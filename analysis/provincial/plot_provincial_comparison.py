...
data = [
    ("Shandong",       578.1, 491.3, 701.7),
    ("Inner Mongolia", 570.3, 171.6, 378.8),
    ("Jiangsu",        507.4,  48.2, 637.2),
    ("Guangdong",      504.8, 207.0, 681.5),
    ("Sichuan",        416.7, 640.7, 270.7),
    ("Xinjiang",       405.2, 129.8, 313.4),
    ("Yunnan",         367.4, 228.0, 186.5),
    ("Zhejiang",       352.1, 311.8, 419.8),
    ("Shanxi",         339.5, 229.1, 239.9),
    ("Hubei",          303.7, 209.3, 230.8),
    ("Hebei",          294.5, 312.7, 410.1),
    ("Henan",          279.1, 272.7, 368.2),
    ("Anhui",          278.5, 244.0, 265.7),
    ("Fujian",         263.6, 261.9, 245.5),
    ("Shaanxi",        242.6, 185.0, 198.3),
    ("Guizhou",        232.7, 165.5, 158.7),
    ("Liaoning",       203.9, 314.8, 257.5),
    ("Guangxi",        193.9, 252.5, 196.8),
    ("Gansu",          178.7, 154.8, 132.0),
    ("Ningxia",        176.8,  16.0, 112.0),
    ("Hunan",          155.2, 393.0, 190.0),
    ("Jiangxi",        147.7, 212.4, 199.3),
    ("Heilongjiang",   111.1, 251.2, 102.2),
    ("Jilin",           99.0, 200.0,  78.7),
    ("Qinghai",         94.8,  37.1,  74.0),
    ("Shanghai",        86.4, 240.2, 157.7),
    ("Chongqing",       83.7, 235.1, 119.6),
    ("Hainan",          34.8,  31.9,  36.6),
    ("Tibet",            8.7,  15.1,   8.8),
]
