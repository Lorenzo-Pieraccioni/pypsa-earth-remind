...
* Improve hydro scaling to ensure total inflows match by technology `PR #1707 <https://github.com/pypsa-meets-earth/pypsa-earth/pull/1707>`__
...
* Update snakemake to 9.x, add execution profile
